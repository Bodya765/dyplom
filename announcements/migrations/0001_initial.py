    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='announcements', to=settings.AUTH_USER_MODEL, verbose_name='Автор')),
        ...
        migrations.AddIndex(
            model_name='announcement',
            index=models.Index(fields=['owner'], name='announcemen_owner_i_8d7f74_idx'),
        ),
